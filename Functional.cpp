...
double SimpleOption::getInTheMoneyProbability(int numDays, double currentUnderlyingPrice)
const
{
    return 0;
}
...
auto computeInTheMoneyPorbExample(const std::vector<SimpleOption> &options) ->
std::vector<double>
{
    using namespace std;
    using namespace std::placeholders;
